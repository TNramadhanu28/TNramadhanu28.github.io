<div class="content">
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            ...
            <a href="<?= site_url('dashboard') ?>" class="btn btn-danger shadow-md mr-2">Lanjutkan Belanja</a>
        </div>
    </div>
                ...
                <div class="overflow-auto lg:overflow-visible -mt-3">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="4"></td>
                                <td class="text-right"><strong>Rp. <?= number_format($this->cart->total(), 0, ',', '.') ?>,-</strong><br><p>Belum termasuk pajak*</p></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
