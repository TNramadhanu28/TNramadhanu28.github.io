                ...
                <table class="table table-report -mt-2">
                    <thead>
                        <tr>
                            ...
                            <th class="whitespace-nowrap">ID ORDER</th>
                            ...
                            <th class="text-center whitespace-nowrap">TINDAKAN</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($invoice as $row) : ?>
                            <tr class="intro-x">
                                ...
                                <td>
                                  <?php if ($row->status == "0"){ ?>
                                    <div class="flex items-center whitespace-nowrap text-pending"><b>TERTUNDA</b> </div>
                                <?php } else if ($row->status == "1"){ ?>
                                    <div class="flex items-center whitespace-nowrap text-success"> <b>DIBAYAR</b> </div>
                                <?php } ?>
                            </td>
