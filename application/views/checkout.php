<div class="content">
    ...
    <div class=" pos intro-y grid grid-cols-12 gap-5 mt-5">
        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            <div class="alert alert-primary show mb-2" role="alert">Jumlah Total Harga Barang (belum terrmasuk pajak*) : <b>Rp. <?= number_format($grand_total, 0, ',', '.') ?>,-</b></div>
            <div class="post intro-y overflow-hidden box mt-5">
                <ul class="post__tabs nav nav-tabs flex-col sm:flex-row bg-slate-200 dark:bg-darkmode-800" role="tablist">
                    <li class="nav-item">
                        <button title="Fill in the article content" data-tw-toggle="tab" data-tw-target="#content" class="nav-link tooltip w-full sm:w-200 py-4 active" id="content-tab" role="tab" aria-controls="content" aria-selected="true"> <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Rincian Pengiriman </button>
                    </li>
                </ul>
                    ...
                    <form id="payment-form" action="<?= site_url('dashboard/checkout_proccess') ?>" method="post">
                        <div id="content" class="tab-pane p-5 active" role="tabpanel" aria-labelledby="content-tab">
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                <div class="font-medium flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5"> <i data-lucide="chevron-down" class="w-4 h-4 mr-2"></i> Informasi Pengguna </div>
                                <div class="mt-5">
                                    <div class="mb-5">
                            ...
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5 mt-5">
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="mb-5">
                                        <label for="post-form-7" class="form-label">Kabupaten / Kota <small class="text-danger">*</small></label>
                                    ...
                                    <div class="mb-5">
                                        <label for="post-form-7" class="form-label">Jasa pengiriman <small class="text-danger">*</small></label>
                            ...
                            <div class="flex mt-5">
                                ...
                                <button type="submit" class="btn btn-primary w-32 shadow-md ml-auto">Bayar Pesanan</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div id="ticket" class="tab-pane active" role="tabpanel" aria-labelledby="ticket-tab">
                <div class="box p-2 mt-5">
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        ...
                        <div class="ml-auto font-medium">6750527090 / ARKAS Commerce</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                        ...
                        <div class="text-slate-500"></div>
                        <div class="ml-auto font-medium">1918009817 / ARKAS Commerce</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                        ...
                        <div class="text-slate-500"></div>
                        <div class="ml-auto font-medium">6721598021 / ARKAS Commerce</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                    ...
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                            <img class="mt-2" src="<?= site_url('asset') ?>/dana.png" width="50">
                        </div>
                        <div class="text-slate-500"></div>
                        <div class="ml-auto font-medium">0895321364851 / ARKAS Commerce</div>
                    </a>
                </div>
                <?php
                    // Menghitung subtotal dari keranjang belanja
                    $subtotal = $this->cart->total(); // Anda mungkin perlu menyesuaikan ini dengan cara mengambil subtotal yang sesuai

                    // Menghitung pajak dari subtotal
                    $pajak = $subtotal * 0.11;

                    // Menampilkan informasi pajak dalam format mata uang Rupiah
                    $pajak_formatted = number_format($pajak, 0, ',', '.');

                    // Menghitung total pembayaran (subtotal + pajak)
                    $total_pembayaran = $subtotal + $pajak;
                    $total_pembayaran_formatted = number_format($total_pembayaran, 0, ',', '.');
                 ?>
                ...
                <div class="box p-5 mt-5">
                    ...
                    <div class="flex mt-4">
                        ...
                        <div class="font-medium">Rp. <?= $pajak_formatted ?></div>
                    </div>
                    <div class="flex mt-4 pt-4 border-t border-slate-200/60 dark:border-darkmode-400">
                        <div class="mr-auto font-medium text-base">Total Pembayaran</div>
                        <div class="font-medium text-base"><strong>Rp. <?= $total_pembayaran_formatted ?>,-</strong></div>
                    </div>
                </div>
            </div>
        </div>
