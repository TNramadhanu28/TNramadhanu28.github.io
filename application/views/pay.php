            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap">MELACAK NOMOR</th>
                        ...
                        <th class="whitespace-nowrap">ULASAN</th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($bill as $row) : ?>
                        <tr class="intro-x">
                            ...
                            <td>
                                <a class="btn btn-sm btn-rounded-success text-white">Diverifikasi</a>
                            </td>
                            <td>
                                <a href="<?= site_url('bill/ulasan/') ?>" class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">Berikan Ulasan</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
