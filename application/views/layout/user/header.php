    ...
    <div class="top-bar-boxed h-[70px] z-[51] relative border-b border-white/[0.08] mt-12 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
        <div class="h-full flex items-center">
            ...
            <a href="" class="-intro-x hidden md:flex">
                ...
                <span class="text-white text-lg ml-3"> ARKAS </span>
            </a>
            <!-- END: Logo -->
            <!-- BEGIN: Breadcrumb -->
                ...
                <ul>
                    ...
                    <li style="display: inherit;">
                        <a href="#" class="side-menu">
                            ...
                            <div class="side-menu__title"> Buku Pelajaran </div>
                        </a>
                        <ul class="katalog">
                            <center>
                            <li><a href="<?= base_url('categories/umum') ?>" style="text-decoration: none; color: white; font-weight: bold; font-size: 16px; display: block; padding:10px;">Buku Reguler</a></li>
                            <li><a href="<?= base_url('categories/bebas') ?>" style="text-decoration: none; color: white; font-weight: bold; font-size: 16px; display: block; padding:10px;">Buku Literasi</a></li>
                            </center>
                        </ul>
                    </li>
                    <li>
                        <a href="<?= base_url('categories/alat') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title">
                            Alat Tulis
                    ...
                    <li>
                        <a href="#" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title"> Alat Peraga Pelajaran </div>
                        </a>
                        <ul class="katalog">
                            <center>
                            <li><a href="<?= base_url('categories/mtk') ?>" style="text-decoration: none; color: white; font-weight: bold; font-size: 16px; display: block; padding:10px;">Matematika</a></li>
                            <li><a href="<?= base_url('categories/biologi') ?>" style="text-decoration: none; color: white; font-weight: bold; font-size: 16px; display: block; padding:10px;">Biologi</a></li>
                            <li><a href="<?= base_url('categories/fisika') ?>" style="text-decoration: none; color: white; font-weight: bold; font-size: 16px; display: block; padding:10px;">Fisika</a></li>
                            <li><a href="<?= base_url('categories/kimia') ?>" style="text-decoration: none; color: white; font-weight: bold; font-size: 16px; display: block; padding:10px;">Kimia</a></li>
                            <li><a href="<?= base_url('categories/kesenian') ?>" style="text-decoration: none; color: white; font-weight: bold; font-size: 16px; display: block; padding:10px;">Kesenian</a></li>
                            </center>
                        </ul>
                    </li>
                    <li style="display: inherit;">
                        <a href="#" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title"> Olahraga </div>
                        </a>
                        <ul class="katalog">
                            <center>
                            <li><a href="<?= base_url('categories/perangkat') ?>" style="text-decoration: none; color: white; font-weight: bold; font-size: 16px; display: block; padding:10px;">Peralatan</a></li>
                            <li><a href="<?= base_url('categories/bola') ?>" style="text-decoration: none; color: white; font-weight: bold; font-size: 16px; display: block; padding:10px;">Bola</a></li>
                            </center>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="<?= base_url('categories/elektronik') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title"> Elektronic </div>
                        </a>
                    </li>

                    <li>
                        <a href="<?= base_url('categories/kesehatan') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                    ...
                    <li>
                        <a href="<?= base_url('categories/kebersihan') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title"> Kebersihan </div>
                        </a>
